...
```bash
cp .claude/jobops/templates/*.md .jobops/templates/default/ 2>/dev/null || true
cp -r .claude/jobops/templates/latex .jobops/templates/default/
```
...
back to:
```bash
find .claude/jobops/templates -maxdepth 1 -type f -exec cp {} .jobops/templates/default/ \;
cp -r .claude/jobops/templates/latex .jobops/templates/default/
```
